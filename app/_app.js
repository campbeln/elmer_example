    ...
    $app.app = {
        ...
        services: { //# collection of external services
            web: {
                ...
                //# Determines if the sAPIName's heartbeat endpoint is up and running
                apiUp: async function (sAPIName) {
                    oAPIResponse = await $app.io.net.get(
                        "http://" + sAPIName + "." + $app.app.config.hostname + ":" + $app.app.config.port + "/"
                    );
